...
import com.example.haipham.uberandroid.common.Common;
...
//    private Button btnGo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        location_switch.setOnCheckedChangeListener(b -> {
            if (b) {
                startLocationUpdate();
                displayLocation();
        ...
        placeAutocomplete.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                if(location_switch.isChecked()){
                    ...
                    Toast.makeText(MapsActivity.this, "Please change your status is ONLINE", Toast.LENGTH_SHORT).show();
                }
            }
...
//                        rotateMarket(mCurrent, -360, mMap);
    ...
    private void rotateMarket(Marker mCurrent, int i, GoogleMap mMap) {
        Handler handler = new Handler();
        long start = SystemClock.uptimeMillis();
        float statRotation = mCurrent.getRotation();
        long duration = 1500;
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                float rot = t * i + (1 - t) * statRotation;
